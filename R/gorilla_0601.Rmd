...
library(ggplot2)
options(digits=3)
# gorilla <- read.xlsx("../data/gorilla0601.xlsx", 1, startRow = 2, endRow = 66, header = FALSE, colIndex = c(3:7, 9:31), colClasses = c(rep("character", 17), "numeric", "character", "numeric", rep("character", 6), "numeric", "character"))
