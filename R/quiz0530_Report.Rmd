...
quiz0530$Q5.2[Red] <- ifelse(quiz0530$Q5[Red] == "가", "티켓 분실", ifelse(quiz0530$Q5[Red] == "나", "티켓 분실", NA))
quiz0530$Q5.2[Black] <- ifelse(quiz0530$Q5[Black] == "가", "현금 분실", ifelse(quiz0530$Q5[Black] == "나", "현금 분실", NA))
quiz0530$Q5.3[Red] <- ifelse(quiz0530$Q5[Red] == "가", "산다", ifelse(quiz0530$Q5[Red] == "나", "안 산다", NA))
quiz0530$Q5.3[Black] <- ifelse(quiz0530$Q5[Black] == "가", "산다", ifelse(quiz0530$Q5[Black] == "나", "안 산다", NA))
# str(quiz0530)
```
...
tbl.q5 <- table(quiz0530$Q5.2, quiz0530$Q5.3)
