...
pander(addmargins(table(quiz0302$group, quiz0302$Q1, exclude = NULL), margin=1))
```
...
pander(addmargins(table(quiz0302$group, quiz0302$Q2, exclude = NULL), margin=1))
```
...
pander(addmargins(table(quiz0302$group, quiz0302$Q3, exclude = NULL), margin=1))
```
