...
# quiz1107$Q4.2 <- quiz1107$Q4
quiz1107$Q4.2[Red] <- ifelse(quiz1107$Q4[Red] == "가", "확실히", ifelse(quiz1107$Q4[Red] == "나", "확률적으로", NA))
quiz1107$Q4.2[Black] <- ifelse(quiz1107$Q4[Black] == "가", "확실히", ifelse(quiz1107$Q4[Black] == "나", "확률적으로", NA))
quiz1107$Q4.2 <- factor(quiz1107$Q4.2, levels = c("확실히", "확률적으로"))
str(quiz1107)
```
...
tbl <- table(quiz1107$group, quiz1107$Q4.2, useNA = "ifany")
