...
quiz0418 <- read.xlsx("../../class201601/data/quiz0418.xlsx", 1, startRow = 2, endRow = 66, colIndex = c(3:7, 9:14), colClasses = c(rep("character", 11)), stringsAsFactors=FALSE)
str(quiz0418)
