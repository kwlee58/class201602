...
quiz1123$Q5 <- factor(quiz1123$Q5,
                      levels = c("가", "나"),
                      labels = c("산다", "안 산다"))
# str(quiz1123)
```
...
tbl.q5 <- table(quiz1123$group, quiz1123$Q5, useNA = "ifany")
...
tbl.q5.p.a <- addmargins(round(prop.table(tbl.q5[1:2, 1:2], margin = 1)*100, digits = 1))[1:2, ]
